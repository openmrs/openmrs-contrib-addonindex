...
// Lets the currently-viewed add-on hide the global core-version picker when the add-on has no
// platform requirement (e.g. frontend modules), where filtering by core version is meaningless.
export const VersionPickerVisibilityContext = createContext<
    ...
    <Analytics>
      <QueryClientProvider client={queryClient}>
        <CoreVersionContext.Provider value={openmrsCoreVersion}>
          <VersionPickerVisibilityContext.Provider value={setShowVersionPicker}>
          ...
          </VersionPickerVisibilityContext.Provider>
